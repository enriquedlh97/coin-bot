...
# When a 'message' event is detected by the events adapter, forward that
# payload
# to this function.
...
def message(payload):
    ...
    # Check and see if the activation phrase was in the text of the
    # message. If so, execute the code to flip a coin.
    if "hey sammy, flip a coin" in text.lower():
        # Since the activation phrase was met, get the channel ID that
        # the event was executed on
...
if __name__ == "__main__":
    ...
    # Set the log level to DEBUG. This will increase verbosity of
    # logging messages
